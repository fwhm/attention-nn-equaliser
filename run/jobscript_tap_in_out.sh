...
python3 rnn_in_out_taps.py -p=[-3,-2] -g=1 -rnn=lstm -n_h=32 -bi=true -i_ids=[-1:2] -o_ids=[-1:2] & python3 rnn_in_out_taps.py -p=[-1,0] -g=1 -rnn=lstm -n_h=32 -bi=true -i_ids=[-1:2] -o_ids=[-1:2] & python3 rnn_in_out_taps.py -p=[1,2] -g=1 -rnn=lstm -n_h=32 -bi=true -i_ids=[[-1:2] -o_ids=[-1:2] & python3 rnn_in_out_taps.py -p=[3,4] -g=1 -rnn=lstm -n_h=32 -bi=true -i_ids=[-1:2] -o_ids=[-1:2] & python3 rnn_in_out_taps.py -p=[5] -g=1 -rnn=lstm -n_h=32 -bi=true -i_ids=[-1:2] -o_ids=[-1:2]
