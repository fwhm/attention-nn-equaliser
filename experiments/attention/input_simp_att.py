"""Attention layer added BEFORE RNN layer to get self-attention on input symbols"""
# Internal
...
from experiments.models import SimpAttInput
...
MODEL_SAVE_PATH = os.path.join(OUTPUT_COLLECTION_PATH, "input_simp_att")
...
for plch in LAUNCH_POWER_RANGE:
    ...
    for fold in range(1, NUM_CROSS_VAL_FOLDS + 1):
        ...
        # ########## SET UP MODEL ########## #
        model = SimpAttInput(**network_args).to(DEVICE)
