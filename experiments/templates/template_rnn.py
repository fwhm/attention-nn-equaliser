...
from utils.parsers import get_plch_array, RnnParser
...
# ########## ARGUMENT PARSER ########## #
args, arg_str_plch, args_dir_str = RnnParser().parsers()
...
MODEL_SAVE_PATH = os.path.join(OUTPUT_COLLECTION_PATH, "template_rnn")
